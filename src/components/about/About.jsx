  ...
  return (
    <div className="about">
      ...
      <div className="wrapper">
        {/** Conditionally apply motion.div */}
        {isMobile ? (
          <div className="intro">
            <h2>Get to know me!</h2>
            <p>
              I'm a Frontend-Focused Web Developer who strive to create smooth, user-friendly experiences that contribute to the success of the overall product.
              <br /> <br />
              I enjoy learning and improving my skills in web development, constantly exploring new technologies and best practices.
              <br />
              <br />
              I'm always open to exciting job opportunities, if you have an opportunity that matches my skills and experience, feel free to reach out!
            </p>
            <button onClick={() => window.open("https://drive.google.com/file/d/1R5ed2XHYckmZfAjzlj3qsLcVoOXHHnQ8/view?usp=sharing", "_blank")}>My Resume</button>
          </div>
        ) : (
